...
base = 'C:\\Users\\ShiqiZhang\\Downloads\\abobe-sdk\\util\\'

with open(f"{base}README.md", "r", encoding='utf-8') as fh:
...
setuptools.setup(
    ...
    python_requires=">=3.6",
    install_requires=parse_requirements(f'{base}requirements.txt', session=False),
    classifiers=[
